...
describe("ColorParser", function () {
  ...
  const asColor = (value) => `color:${value}`;

  const getParser = function (context) {
    context = new ColorContext(context != null ? context : { registry });
  ...
  const itParses = function (expression) {
    return {
      ...
      withContext(variables) {
        ...
        this.context = { variables: vars, colorVariables: colorVars, registry };
  ...
  itParses("adjust-color($d, $red: $a, $blue: $b)")
    .withContext({
      $a: "-5",
      $b: "5",
      $d: asColor("rgba($c, 1)"),
    ...
    .asInvalid();
  itParses("adjust-color($c, $red: $a, $blue: $b)")
    .withContext({
      $a: "-5",
      $b: "5",
      $c: asColor("#102030"),
  ...
  itParses("scale-color($d, $green: $a, $blue: $b)")
    .withContext({
      $a: "-40%",
      $b: "70%",
      $d: asColor("rgba($c, 1)"),
    ...
    .asInvalid();
  itParses("scale-color($c, $green: $a, $blue: $b)")
    .withContext({
      $a: "-40%",
      $b: "70%",
  ...
  itParses("contrast(@base)")
    ...
    .asColor(255, 255, 255);
  itParses("contrast(@base, @dark)")
    .withContext({
      "@base": asColor("#bbbbbb"),
      "@dark": asColor("rgb(20,20,20)"),
    })
    .asColor(20, 20, 20);
  itParses("contrast(@base, @dark, @light)")
    .withContext({
      "@base": asColor("#333333"),
      "@dark": asColor("rgb(20,20,20)"),
    ...
    .asColor(140, 140, 140);
  itParses("contrast(@base, @dark, @light, @threshold)")
    .withContext({
      "@base": asColor("#666666"),
      "@dark": asColor("rgb(20,20,20)"),
      "@light": asColor("rgb(140,140,140)"),
  ...
  itParses("multiply(@base, @modifier)")
    .withContext({
      "@base": asColor("#ff6600"),
  ...
  itParses("overlay(@base, @modifier)")
    .withContext({
      "@base": asColor("#ff6600"),
      "@modifier": asColor("#666666"),
    })
  ...
  itParses("softlight(@base, @modifier)")
    .withContext({
      "@base": asColor("#ff6600"),
      "@modifier": asColor("#666666"),
    })
  ...
  itParses("hardlight(@base, @modifier)")
    .withContext({
      "@base": asColor("#ff6600"),
      "@modifier": asColor("#666666"),
    })
  ...
  itParses("difference(@base, @modifier)")
    .withContext({
      "@base": asColor("#ff6600"),
      "@modifier": asColor("#666666"),
    })
  ...
  itParses("exclusion(@base, @modifier)")
    .withContext({
      "@base": asColor("#ff6600"),
      "@modifier": asColor("#666666"),
    })
  ...
  itParses("average(@base, @modifier)")
    .withContext({
      "@base": asColor("#ff6600"),
      "@modifier": asColor("#666666"),
    })
  ...
  itParses("average(@gradient-b, @gradient-mean)")
    .withContext({
  ...
  itParses("negation(@base, @modifier)")
    .withContext({
      "@base": asColor("#ff6600"),
      "@modifier": asColor("#666666"),
    })
  ...
  itParses("transparentify(a)")
    .withContext({
      a: asColor("#808080"),
    })
    .asColor(0, 0, 0, 0.5);
  itParses("transparentify(a, b, 0.5)")
    .withContext({
      a: asColor("#91974C"),
      b: asColor("#F34949"),
    })
  ...
  describe("CSS color function", function () {
    ...
    itParses("COLOR(#fd0cc7 tint(66%))").asColor(254, 172, 236);
    itParses("cOlOr(#fd0cc7 tint(66%))").asColor(254, 172, 236);
    return itParses("color(var(--foo) tint(66%))")
      .withContext({
